...
<head>
    ...
    <title>FSP || Manage Candidates</title>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="manage-teacher.php">Manage Candidates</a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Manage Candidates</strong>
                            </div>
                            <div class="card-body">
...
<td><a href="mail.php?mailid=<?php echo htmlentities ($row->Email);?>" class="btn btn-primary">Invite</a>
                  </td>
                </tr>
               <?php $cnt=$cnt+1;}} ?>   
