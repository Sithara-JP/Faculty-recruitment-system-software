                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="add-teacher.php">Candidate Details</a></li>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-header"><strong>Candidate</strong><small>  Personal Details </small></div>
                            ...
                            <div class="card-body card-block">
                                ...
                                <div class="form-group"><label for="company" class=" form-control-label">Profile picture </label><input type="file" name="propic" value="" class="form-control" id="propic" required="true"></div>
...
<!---------------------------------------------------------->
 <div class="col-lg-6">
                        <div class="card">
                            <div class="card-header"><strong>Candidate</strong><small>  Proffessional Details </small></div>
                            ...
                            <div class="card-body card-block">
                                            ...
                                            <div class="row form-group">
                                                <div class="col-12">
                                                    <div class="form-group"><label for="city" class=" form-control-label">Qualification </label><input type="text" name="qualifications" id="qualifications" value="" class="form-control" required="true"></div>
                                                    </div>
                                                    </div>
...
<div class="form-group"><label for="company" class=" form-control-label">Resume / CV</label><input type="file" name="propic" value="" class="form-control" id="resume" required="true"></div>
                                                    <div class="col-12">
