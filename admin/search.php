                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="search.php">Search Candidate</a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Search Candidate</strong>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="card-box">
                                       ...
                                       <div class="form-group row">
                                                        <label class="col-4 col-form-label" for="example-email" style="padding-left: 50px"><strong>Search by candidate name</strong></label>
                                                        <div class="col-6">
